...
arduinoData = serial.Serial(usb, 9600)  # 115200
arduinoData.flush()
...
freq = 500              # 1/T   -> T is the arduino delay in seconds
...
p2.setRange(yRange=[0,200000], xRange=[0, int(freq/2)])
p2.setLabel('bottom',
...
def update():
    ...
    try:
        ...
        acelerometroz = int(dataArray[0])/8 # 16384, 8192, 4096, 2048 for accelerometer set 2, 4, 8, 16g
